...
if options.configFile == None:
    ...
    if options.useThisProjectArea:
        options.configFile = os.path.join(os.environ['CMSSW_BASE'],"src/HLTriggerOffline/Egamma/test/testEmDQMFeeder_cfg.py")
    else:
        options.configFile = "test/testEmDQMFeeder_cfg.py"
